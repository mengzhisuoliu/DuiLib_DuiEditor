...
#define DUITRACEMSG _T("")
	...
	public:
		...
		virtual LRESULT HandleMenuCommandMessage(UINT uMsg, WPARAM wParam, LPARAM lParam, uiBool& bHandled);
		...
		virtual LRESULT OnRButtonDown(UINT uMsg, WPARAM wParam, LPARAM lParam, uiBool& bHandled);
		virtual LRESULT OnRButtonUp(UINT uMsg, WPARAM wParam, LPARAM lParam, uiBool& bHandled);
		...
		virtual LRESULT OnTimer(UINT uMsg, WPARAM wParam, LPARAM lParam, uiBool& bHandled);
		virtual LRESULT OnMouseActivate(UINT uMsg, WPARAM wParam, LPARAM lParam, uiBool& bHandled);
		virtual LRESULT OnEraseBkgnd(UINT uMsg, WPARAM wParam, LPARAM lParam, uiBool& bHandled);
		virtual LRESULT OnPaint(UINT uMsg, WPARAM wParam, LPARAM lParam, uiBool& bHandled);
		virtual LRESULT OnPrint(UINT uMsg, WPARAM wParam, LPARAM lParam, uiBool& bHandled);
	public:
		UIWND m_hWnd;
