...
cmake .. -G "Ninja" -DCMAKE_TOOLCHAIN_FILE="%ANDROID_NDK%/build/cmake/android.toolchain.cmake" -DANDROID_ABI=%ABI% -DANDROID_PLATFORM=android-21 -DBUILD_SHARED_LIBS=ON -DSDL3_DIR="../%SDL3_BUILD_DIR%"
